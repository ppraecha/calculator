...
class Ui_MainWindow(object):
    ...
    def dot_it(self):
        screen = self.outputlabel.text()
        temp = screen.replace("+", ",").replace("-", ",").replace("*", ",").replace("/", ",").split(",")
        if "." in temp[-1]:
            pass
        else:
    ...
    def press_it(self, pressed):
        screen = self.outputlabel.text()
        if pressed == "+" or pressed == "-" or pressed == "*" or pressed == "/":
            temp = screen.replace("+", ",").replace("-", ",").replace("*", ",").replace("/", ",").split(",")
            if temp[-1] == "":
                if screen[-1] != pressed:
                    self. outputlabel.setText(screen[0:len(screen)-1] + pressed )
            else:
            ...
            temp = screen.replace("+", ",").replace("-", ",").replace("*", ",").replace("/", ",").split(",")
            current = temp[-1]
            self.outputlabel.setText(screen[0:screen.rfind(current)])      
